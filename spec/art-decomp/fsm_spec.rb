...
module ArtDecomp # rubocop:disable ModuleLength
  describe FSM do
    ...
    describe '#beta_qp' do
      it 'returns the Q’ Blanket' do
        opus.beta_qp.must_equal Blanket[B[0,1], B[2,3,9], B[4,14], B[5,6],
                                        B[7,8,20,21], B[10,16], B[11,18],
                                        B[12,15], B[13,17], B[19]]
    ...
    describe '#beta_x' do
      ...
      it 'returns the full input Blanket when called without parameters' do
        mc.beta_x.must_equal Blanket[B[0,1,3,6,8], B[0,1,4,6,9], B[0,3,6,7,8],
                                     B[0,4,6,7,9], B[1,3,5,8], B[1,4,5,9],
                                     B[2,3,7,8], B[2,4,7,9]]
      end
    ...
    describe '#beta_y' do
      ...
      it 'returns the given output’s Blanket' do
    ...
    describe '#codes' do
      it 'returns encodings for an encoded FSM' do
        one_hot.codes.must_equal(state1:  :'100000000000000',
                                 state3:  :'010000000000000',
                                 state2:  :'001000000000000',
                                 state0:  :'000100000000000',
                                 state4:  :'000010000000000',
                                 state13: :'000001000000000',
                                 state10: :'000000100000000',
                                 state9:  :'000000010000000',
                                 state8:  :'000000001000000',
                                 state7:  :'000000000100000',
                                 state6:  :'000000000010000',
                                 state5:  :'000000000001000',
                                 state14: :'000000000000100',
                                 state11: :'000000000000010',
                                 state12: :'000000000000001')
        nova.codes.must_equal(state1: :'0100', state2: :'1000', state3: :'1011',
                              state4: :'1100', state5: :'0001', state6: :'0011',
                              state7: :'0000', state8: :'0010', state9: :'1101',
                              state10: :'1010', state11: :'0111',
                              state12: :'1001', state13: :'0101',
                              state14: :'0110', state0: :'1110')
        jedi.codes.must_equal(state1: :'0001', state3: :'1111', state2: :'0011',
                              state0: :'1101', state4: :'1001',
                              state13: :'1010', state10: :'1000',
                              state9: :'1100', state8: :'0010', state7: :'0000',
                              state6: :'0110', state5: :'0100',
                              state14: :'1110', state11: :'0111',
                              state12: :'1011')
      end
    end
    ...
    describe '#unique_relevance' do
      it 'returns its unique input relevance, and drops irrelevant inputs' do
        ...
        s8.unique_relevance.must_equal    [nil, nil, nil, 3, 2, 1, 0]
