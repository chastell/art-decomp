...
module ArtDecomp describe FSM do
  ...
  describe '.from_kiss' do
    ...
    it 'parses both KISS files and strings' do
      @mc.must_equal FSM.from_kiss(File.read 'spec/fixtures/mc')
    end
    ...
    it 'handles encoded KISS files' do
      @one_hot.must_equal FSM.from_kiss('spec/fixtures/mark1')
      @nova.must_equal    FSM.from_kiss('spec/fixtures/mark1')
      @jedi.must_equal    FSM.from_kiss('spec/fixtures/mark1')
    end
  ...
  describe '#==' do
    ...
    it 'compares two FSMs' do
      @lion.wont_equal FSM.from_kiss('spec/fixtures/opus')
